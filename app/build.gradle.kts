...
android {
    ...
    compileSdk = 36
    defaultConfig { applicationId = "app.morphe.jam.companion"; minSdk = 26; targetSdk = 37; versionCode = 8; versionName = "1.0.7"; testInstrumentationRunner = "app.morphe.jam.companion.DeviceScenario" }
