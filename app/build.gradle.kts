...
android {
    ...
    compileSdk = 36
    defaultConfig { applicationId = "app.morphe.jam.companion"; minSdk = 26; targetSdk = 37; versionCode = 7; versionName = "1.0.6"; testInstrumentationRunner = "app.morphe.jam.companion.DeviceScenario" }
